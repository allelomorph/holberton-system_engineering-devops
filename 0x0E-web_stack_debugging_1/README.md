...
### :white_check_mark: 0. Nginx likes port 80
...
File(s): [`0-nginx_likes_port_80`](./0-nginx_likes_port_80)

### :white_check_mark: 1. Make it sweet and short
...
File(s): [`1-debugging_made_short`](./1-debugging_made_short)
