...
### :white_check_mark: 0. Gather data from an API
...
### :white_check_mark: 1. Export to CSV
...
### :white_check_mark: 2. Export to JSON
...
### :white_check_mark: 3. Dictionary of list of dictionaries
Using what you did in the task #0, extend your Python script to export data in the JSON format.
